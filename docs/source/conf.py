...
htmlhelp_basename = 'centroidsdoc'
...
latex_documents = [
    (master_doc, 'centroids.tex', 'centroids Documentation',
...
man_pages = [
    (master_doc, 'centroids', 'centroids Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'centroids', 'centroids Documentation',
     author, 'centroids', 'One line description of project.',
     'Miscellaneous'),
]
